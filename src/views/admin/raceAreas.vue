        ...
        >
          ...
          >
            <el-form-item
              ...
              required
            >
              <el-input v-model="ruleForm.matchArea" placeholder="请输入赛区名称">
              </el-input>
            </el-form-item>
            ...
            <el-form-item label="赛区学校" prop="hostSchool" required>
              <el-input v-model="ruleForm.hostSchool" placeholder="请输入赛区学校"
              >
              </el-input>
            </el-form-item>
          </el-form>
        ...
        methods: {
            ...
            handleDelete(row){
               ...
               this.$confirm("您确定删除此条数据吗?", "提示", {
                    ...
                    .then(() => {
                        this.getData(`/matchAreaMessage/del?id=${row.id}`,"get").then(res=>{
                ...
                this.$refs["add_or_edit_Form"].validate(valid => {
                    if (valid) {
                        ...
                        if(this.dialogStatus=="create"){
                            this.getData("/matchAreaMessage/add","post",this.ruleForm).then(res=>{
                                console.log("添加",res)
                            ...
                            this.getData("/matchAreaMessage/update","post",this.ruleForm).then(res=>{
                                console.log("更新",res)
                               this.dialogFormVisible = false;
                                this.$message({
                                    message: "编辑成功",
            ...
            getList(){
               this.getData(`/matchAreaMessage/pageList?pageIndex=1&pageSize=10`,"get").then(res=>{
                    console.log("：：：",res)
                    if(res.data.code==200){
